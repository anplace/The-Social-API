...
## GitHub Repository:
[GitHub Repository:](https://github.com/anplace/The-Social-API)
...
- Nodemon: [2.0.21](https://www.npmjs.com/package/nodemon/v/2.0.12)
...
## Credits
  - Thomas Calle for the README template which I tweaked to fit my needs.